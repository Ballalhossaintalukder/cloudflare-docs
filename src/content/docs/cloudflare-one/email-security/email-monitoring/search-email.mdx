...
3. You will be redirected to Security Center's Investigate, where the dashboard will display a summary of the link you selected.
4. Select **Scan now**.
...
You may receive a HTTP 400 Bad Request Error when opening a link in Browser Isolation. Follow these steps if encounter this problem:
...
2. The dashboard will display a certificate if you already have one. If you do not have a certificate:

   - Select **Generate certificate**.
   - Choose the **Expiration** (5 years is recommended), then select **Generate certificate**. Your certificate is now generated, and the dashboard will display its **Deployment Status** as **INACTIVE**.
   - Select the three dots, and then select **Activate** to activate your certificate.
   - Select the three dots, and then select **Mark as in-use**.
   - Your certificate deployment status should display **AVAILABLE IN-USE**.
