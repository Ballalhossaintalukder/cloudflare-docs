...
```js
// get a container-enabled durable object and call an RPC method
...
export class MyContainer extends DurableObject {
  ...
  constructor(ctx, env) {
    ...
    ctx.blockConcurrencyWhile(
      startAndWaitForPort(ctx.container, 4000)
    );
  }
...
<LinkTitleCard
	...
	href="/containers/reference/closed-beta-info/"
	icon="seti:shell"
>
	Learn about the Closed Beta and upcoming features.
</LinkTitleCard>

<LinkTitleCard
	title="Limits"
	href="/containers/reference/limits/"
	icon="document"
>
